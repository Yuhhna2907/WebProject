...
public class UserDAO implements IUserDAO {
    ...
    private static final String SELECT_USERS_BY_COUNTRY =
            "select * from users where country like ?";

    private static final String SORT_USERS_BY_NAME =
    ...
    public List<User> selectUsersByCountry(String country) {
        ...
        try (Connection connection = getConnection();
             PreparedStatement preparedStatement =
                     connection.prepareStatement(SELECT_USERS_BY_COUNTRY)) {
    ...
    public List<User> sortUsersByName() {
        ...
        try (Connection connection = getConnection();
             PreparedStatement preparedStatement =
                     connection.prepareStatement(SORT_USERS_BY_NAME)) {
